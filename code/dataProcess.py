...
def get_dataloader(image_paths, label_paths, mode, addNDVI, batch_size, 
    ...
    print("Dataset length:", len(dataset))  # 打印数据集长度
...
import glob
dataset = OurDataset(
    glob.glob(r'G:\test\rs_Unet\Pytorch-Semantic-segmentation-of-remote-sensing\data\round1_train\*.tif'),
    glob.glob(r'G:\test\rs_Unet\Pytorch-Semantic-segmentation-of-remote-sensing\data\round1_train\*.png'),
    "train",
    True
)
