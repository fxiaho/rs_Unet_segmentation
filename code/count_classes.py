...
label_paths = glob.glob(r'G:\test\rs_Unet\Pytorch-Semantic-segmentation-of-remote-sensing\data\round1_train\*.png')
# print(label_paths)
# label_paths = glob.glob(r'G:\test\rs_Unet\test\*.png')
